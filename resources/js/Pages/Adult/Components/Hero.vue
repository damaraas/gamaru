    ...
    >
        ...
        <div class="w-full lg:w-7/12 space-y-6 text-left py-5 lg:py-6 lg:px-10">
            ...
            <p class="text-black text-lg md:text-base font-medium text-justify">
                <strong
                    ...
                    profesional?</strong
                >
                Program ini dirancang untuk kamu yang ingin belajar Mandarin
            ...
            >
                ...
                temukan program terbaik untuk tujuanmu.
            </p>
        </div>
        ...
        <div class="w-full lg:w-5/12 flex justify-center relative mt-6 lg:mt-0">
            <div class="relative">
                ...
                <!-- Gambar -->
                <img
                    :src="'/img/Adult/Maskot Gamaru-18.webp'"
                    alt="Student"
                    class="w-full max-w-[380px] lg:max-w-[440px] xl:max-w-[465px] rounded-lg relative left-3 sm:left-3"
                />
            </div>
        </div>
    </div>

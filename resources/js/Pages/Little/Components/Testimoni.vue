                            ...
                            >
                                <div class="lg:w-1/12 w-full h-[180px] lg:h-auto">
                                    <div class="relative">
                                        <!-- Polygon Background -->
                                        <div
                                            class="absolute top-10 left-[150px] lg:left[100px] -translate-x-1/2 <!-- MOBILE CENTER --> lg:top-[1.2rem] lg:left-[8.6rem] lg:-translate-x-[9.8rem] <!-- DESKTOP POSITION --> xl:left-[150px] xl:top-[1rem] bg-primary z-0 rounded-full w-full max-w-[150px] lg:max-w-[200px] xl:max-w-[300px] aspect-square"
                                        ></div>
                                        ...
                                        <img
                                            ...
                                            alt="Student"
                                            class="absolute left-[160px] -translate-x-1/2 mt-4 <!-- MOBILE CENTER --> lg:relative lg:-left-[10px] lg:translate-x-0 <!-- DESKTOP NORMAL --> lg:w-full max-w-[150px]  rounded-full border-4 border-white"
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-4/12 w-full lg:mt-0 mt-10">
                                    <div class="relative">
                                        <!-- Polygon Background -->
                                        <div
                                            class="absolute left-[11rem] lg:left-[10rem] -top-[1.2rem] -translate-x-[9.8rem] xl:left-[13rem] xl:-top-[20px] bg-primary z-0 rounded-full w-full max-w-[245px] lg:max-w-[300px] xl:max-w-[340px] aspect-square"
                                        ></div>
                                        <!-- Gambar -->
                                        <img
